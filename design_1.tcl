...
\
  ...
  if { [catch {set axis_round_saturate_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.DROP_LSBS {0} $axis_round_saturate_0
  ...
  if { [catch {set axis_round_saturate_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.DROP_LSBS {0} $axis_round_saturate_1
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ssr8_fir_decimator_0_m_axis] [get_bd_intf_pins ssr8_fir_decimator_0/m_axis] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  ...
  connect_bd_net -net axi_dma_3_s_axis_s2mm_tready [get_bd_pins axi_dma_3/s_axis_s2mm_tready] [get_bd_pins system_ila_0/probe1] [get_bd_pins axis_tlast_gen_iq_0/m_axis_tready]
  ...
  connect_bd_net -net axi_gpio_13_gpio_io_o [get_bd_pins axi_gpio_13/gpio_io_o] [get_bd_pins system_ila_0/probe0] [get_bd_pins rfdc_iq_derotator_0/enable]
