...
// ==============================================================
`timescale 1 ns / 1 ps
module rfdc_iq_derotator_RFDC_IQ_DEROTATOR_SINE_LUT_ROM_AUTO_1R (
    address0, ce0, q0, 
    address1, ce1, q1, 
    address2, ce2, q2, 
    address3, ce3, q3, 
...
initial begin
    ...
    $readmemh("./rfdc_iq_derotator_RFDC_IQ_DEROTATOR_SINE_LUT_ROM_AUTO_1R.dat", rom0); 
    $readmemh("./rfdc_iq_derotator_RFDC_IQ_DEROTATOR_SINE_LUT_ROM_AUTO_1R.dat", rom1); 
    $readmemh("./rfdc_iq_derotator_RFDC_IQ_DEROTATOR_SINE_LUT_ROM_AUTO_1R.dat", rom2); 
    $readmemh("./rfdc_iq_derotator_RFDC_IQ_DEROTATOR_SINE_LUT_ROM_AUTO_1R.dat", rom3); 
    $readmemh("./rfdc_iq_derotator_RFDC_IQ_DEROTATOR_SINE_LUT_ROM_AUTO_1R.dat", rom4); 
    $readmemh("./rfdc_iq_derotator_RFDC_IQ_DEROTATOR_SINE_LUT_ROM_AUTO_1R.dat", rom5); 
    $readmemh("./rfdc_iq_derotator_RFDC_IQ_DEROTATOR_SINE_LUT_ROM_AUTO_1R.dat", rom6); 
    $readmemh("./rfdc_iq_derotator_RFDC_IQ_DEROTATOR_SINE_LUT_ROM_AUTO_1R.dat", rom7);
end
