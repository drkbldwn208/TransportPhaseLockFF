...
input   ap_clk;
input   ap_rst_n;
input  [31:0] s_axis_cmd_TDATA;
input   s_axis_cmd_TVALID;
output   s_axis_cmd_TREADY;
input  [3:0] s_axis_cmd_TKEEP;
input  [3:0] s_axis_cmd_TSTRB;
...
output  [0:0] dwell_wait;
 ...
 reg    ap_rst_n_inv;
reg   [15:0] current_fcw;
reg   [0:0] state;
reg   [15:0] dwell_remaining;
reg   [0:0] start_d;
...
wire   [31:0] s_axis_cmd_TDATA_int_regslice;
...
wire   [3:0] s_axis_cmd_TKEEP_int_regslice;
...
wire   [3:0] s_axis_cmd_TSTRB_int_regslice;
...
dwell_fcw_streamer_32_regslice_both #(
    .DataWidth( 32 ))
...
`include "dwell_fcw_streamer_32_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //dwell_fcw_streamer_32
