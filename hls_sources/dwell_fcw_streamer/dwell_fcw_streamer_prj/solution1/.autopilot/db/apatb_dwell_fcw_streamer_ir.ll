; ModuleID = '/home/levlabcukomen/Desktop/VivadoProjects/TransportPhaseLockFF/hls_sources/dwell_fcw_streamer/dwell_fcw_streamer_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_dwell_fcw_streamer_ir(%"class.hls::stream<hls::axis<ap_uint<64>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(16) %s_axis_cmd, i1 zeroext %start, %"struct.ap_uint<32>"* noalias nocapture nonnull %fcw_out, %"struct.ap_uint<1>"* noalias nocapture nonnull %active, %"struct.ap_uint<1>"* noalias nocapture nonnull %dwell_wait) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_dwell_fcw_streamer_hw(i64* %s_axis_cmd_copy.data, i8* %s_axis_cmd_copy.keep, i8* %s_axis_cmd_copy.strb, i1* %s_axis_cmd_copy.last, i1 %start, i32* %fcw_out_copy, i1* %active_copy, i1* %dwell_wait_copy)
...
declare void @apatb_dwell_fcw_streamer_hw(i64*, i8*, i8*, i1*, i1, i32*, i1*, i1*)
...
define void @dwell_fcw_streamer_hw_stub_wrapper(i64*, i8*, i8*, i1*, i1, i32*, i1*, i1*) #6 {
entry:
  ...
  call void @dwell_fcw_streamer_hw_stub(%"class.hls::stream<hls::axis<ap_uint<64>, 0, 0, 0, '8', false>, 0>"* %8, i1 %4, %"struct.ap_uint<32>"* %9, %"struct.ap_uint<1>"* %10, %"struct.ap_uint<1>"* %11)
...
declare void @dwell_fcw_streamer_hw_stub(%"class.hls::stream<hls::axis<ap_uint<64>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, i1 zeroext, %"struct.ap_uint<32>"* noalias nocapture nonnull, %"struct.ap_uint<1>"* noalias nocapture nonnull, %"struct.ap_uint<1>"* noalias nocapture nonnull)
