...
entity dwell_fcw_streamer_64_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity dwell_fcw_streamer_64_regslice_both;

architecture behave of dwell_fcw_streamer_64_regslice_both is
